 ...
 *       &lt;sequence&gt;
 *         &lt;element name="config" type="{urn:config.mobileterminal.schema.fisheries.ec.europa.eu:v1}configList" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable
{
    ...
    protected List<ConfigList> config;
    ...
    public List<ConfigList> getConfig() {
        if (config == null) {
            config = new ArrayList<ConfigList>();
        }
        return this.config;
    }
