...
public class AssetServiceBean {
    ...
    private static final String ASSET_NOT_FOUND = "Could not find any asset with id: ";
    ...
    public Note createNoteForAsset(UUID assetId, Note note, String username) {
        Asset asset = assetDao.getAssetById(assetId);
        nullValidation(asset, ASSET_NOT_FOUND + assetId);
    ...
    public ContactInfo updateContactInfo(ContactInfo contactInfo, String username) {
        ...
        nullValidation(asset, ASSET_NOT_FOUND + contactInfo.getAssetId());
